...
if __name__ == "__main__":
	...
	for a in aa:
		pathname = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "Program/", "Stazioni_Meteo_Trentino", a, "2017", "dati", "csv"))			# pathname iniziale
		final_pathname = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "Program/", "Stazioni_Meteo_Trentino/", a, "2017/", "report", a))	#pathname finale
